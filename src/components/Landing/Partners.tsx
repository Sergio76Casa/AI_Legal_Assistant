                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <h3 className="font-serif text-3xl md:text-4xl text-white leading-tight">
                                <Trans i18nKey="landing.partners.subtitle">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4 group">
                                ...
                                <div>
                                    <p className="text-white font-bold text-sm">{t('landing.partners.commissions')}</p>
                                    <p className="text-slate-500 text-xs">{t('landing.partners.commissions_desc')}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 group">
                                <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary border border-primary/20 group-hover:bg-primary/20 transition-colors">
                                ...
                                <div>
                                    <p className="text-white font-bold text-sm">{t('landing.partners.dashboard')}</p>
                                    <p className="text-slate-500 text-xs">{t('landing.partners.dashboard_desc')}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4 group">
                                <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary border border-primary/20 group-hover:bg-primary/20 transition-colors">
                                ...
                                <div>
                                    <p className="text-white font-bold text-sm">{t('landing.partners.marketing')}</p>
                                    <p className="text-slate-500 text-xs">{t('landing.partners.marketing_desc')}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-amber-500/10 via-primary/5 to-transparent rounded-3xl border border-amber-500/20 p-8 md:p-10 space-y-6">
                            ...
                            <div className="space-y-3 pt-2">
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-sm text-slate-400">{t('landing.partners.step1')}</p>
                                </div>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-sm text-slate-400">{t('landing.partners.step2')}</p>
                                </div>
                                <div className="w-px h-4 bg-white/10 ml-4"></div>
                                <div className="flex items-center gap-3">
                                    ...
                                    <p className="text-sm text-white font-bold">{t('landing.partners.step3')}</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-4 flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-emerald-400 font-bold text-sm">{t('landing.partners.savings')}</p>
                                    <p className="text-slate-500 text-xs">{t('landing.partners.savings_desc')}</p>
                                </div>
                            </div>
                        </div>
                    </motion.div>
