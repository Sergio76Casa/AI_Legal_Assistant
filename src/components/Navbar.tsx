import { LogOut, ShieldCheck, Building2, Crown, FileText } from 'lucide-react';
                ...
                >
                    ...
                    <div className="flex flex-col">
                        ...
                        {tenant ? (
                            ...
                            <span className="text-[10px] text-slate-400 font-medium leading-none mt-0.5">Assistant</span>
                        )}
                    </div>
                </div>
