...
import { Loader2, Plus, List, Settings as SettingsIcon, FileText } from 'lucide-react';
...
import { FieldDictionaryAside } from './FieldDictionaryAside';
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex overflow-hidden lg:h-[calc(100vh-64px)] relative">
                ...
                {/* ── Columna Izquierda: Referencia de Campos ── */}
                <FieldDictionaryAside fieldGroups={fieldGroups} mobileLayer={mobileLayer} />
