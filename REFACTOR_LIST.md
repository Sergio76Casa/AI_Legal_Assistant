# 📋 Lista de Refactorización (Archivos > 300 líneas)

Este documento sirve para trackear los archivos que exceden las 300 líneas de código y necesitan una revisión para mejorar la mantenibilidad y escalabilidad del proyecto.

## 🛠️ Componentes y Lógica (Prioridad Alta)
...
- [ ] `src/locales/ru.json` (1219 líneas)
- [ ] `src/locales/pt.json` (1191 líneas)
- [ ] `src/locales/fr.json` (1171 líneas)
- [ ] `src/locales/es.json` (1170 líneas)
- [ ] `src/locales/ar.json` (1143 líneas)
- [ ] `src/locales/en.json` (1113 líneas)
- [ ] `src/locales/wo.json` (701 líneas)
- [ ] `src/locales/ur.json` (699 líneas)
